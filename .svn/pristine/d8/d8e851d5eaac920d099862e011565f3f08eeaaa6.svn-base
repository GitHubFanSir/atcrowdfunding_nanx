package com.atnanx.atcrowdfunding.user.interceptor;

import com.atnanx.atcrowdfunding.core.bean.TMember;
import com.atnanx.atcrowdfunding.core.common.ServerResponse;
import com.atnanx.atcrowdfunding.core.util.CookieUtil;
import com.atnanx.atcrowdfunding.core.util.JsonUtil;
import com.atnanx.atcrowdfunding.core.util.ShardedRedisPoolUtil;
...
public class AuthorityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (StringUtils.isNotBlank(loginToken)) {
            ...
            user = JsonUtil.Json2Obj(userStr, TMember.class);
        }

        //是admin的后台请求，且没有管理员权限
        if (user==null||(!(userService.checkMemberExist(user.getLoginacct()).isSuccess())&&isAdminRequest)){
